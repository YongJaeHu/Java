 ...
 * @author wengj
 */
public class PpApptSearchGUI extends javax.swing.JFrame {

    /**
     * Creates new form ApptSearchGUI
     */
    public PpApptSearchGUI() {
        initComponents();
    }
    ...
    private void btexitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btexitActionPerformed
        PpApptMenuGUI am = new PpApptMenuGUI();
        am.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PpApptSearchGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PpApptSearchGUI().setVisible(true);
            }
        });
    }
